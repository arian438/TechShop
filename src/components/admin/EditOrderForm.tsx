...
export function EditOrderForm({ order, onClose, onSave }: EditOrderFormProps) {
  ...
  const orderStatuses = [
    ...
    },
    {
      value: 'paid',
      label: 'Оплачен',
      description: 'Заказ оплачен и готов к отправке',
    },
    {
      value: 'shipping',
      label: 'В пути',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedOrder: Order = {
        ...
        deliveredAt:
          formData.status === 'delivered' && !order.deliveredAt
      ...
      toast({ title: 'Ошибка при обновлении заказа', variant: 'destructive' });
    } finally {
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-normal">{formatPrice(order.subtotal)}</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="status" className="font-bold">Текущий статус</Label>
                <Select
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="paymentMethod" className="font-bold">Способ оплаты</Label>
                <Select
              ...
              <div>
                <Label htmlFor="deliveryFee" className="font-bold">Стоимость доставки</Label>
                <Input
                  id="deliveryFee"
                  type="number"
                  step="0.01"
              ...
              <div className="flex justify-between items-center font-bold">
                ...
                <span>
                  {formatPrice(
                    order.subtotal + (parseFloat(formData.deliveryFee) || 0)
                  )}
                </span>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="addressName" className="font-bold">Имя получателя</Label>
                  <Input
                    id="addressName"
                ...
                <div>
                  <Label htmlFor="addressPhone" className="font-bold">Телефон</Label>
                  <Input
                    id="addressPhone"
